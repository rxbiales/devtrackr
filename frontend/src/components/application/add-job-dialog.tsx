    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[450px]">
        <DialogHeader>
          ...
          <DialogDescription>
            O status inicial será definido como "Aplicado".
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          ...
          >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Ex: Pleno, Tech Lead, Backend"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ex: Vercel" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: LinkedIn, Gupy" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <Button
              type="submit"
              className="w-full mt-4 font-bold py-6 text-lg"
            >
